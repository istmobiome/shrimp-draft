...
remove(list = ls())
workflow_name <- "pub" # e.g., med, dada2, etc
...
* [Description of sample data](files/ENA_Sample_SUBMISSION_HYPOXIA-16S.txt)
* [Description of sequence data](files/ENA_PAIRED_FASTQ_SUBMISSION_HYPOXIA-16S.txt)

### Metagenomic

* [Description of sample data](files/ENA_Sample_SUBMISSION_HYPOXIA-MG.txt)
* [Description of sequence data](files/ENA_PAIRED_FASTQ_SUBMISSION_HYPOXIA-MG.txt)
