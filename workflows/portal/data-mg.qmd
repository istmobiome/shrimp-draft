...
Here we provide two options for processing sequence data--the detailed pipeline (listed in the table) and a [quick set of commands linked below](#metagenomic-processing). 
